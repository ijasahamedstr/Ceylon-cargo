    ...
    <Box component="footer" sx={{ fontFamily: primaryFont }}>
      ...
      >
        <Container maxWidth="lg">
          ...
          >
            ...
            {/* Address Section - Updated with 3 KSA Cities + Sri Lanka */}
            <Box sx={{ flexBasis: { xs: "100%", md: "35%" } }}>
              <Typography
                variant="h6"
                sx={{ mb: 3, fontSize: "0.9rem", fontWeight: 800, fontFamily: primaryFont, color: brandBlue, letterSpacing: 1 }}
              >
                OFFICE LOCATIONS
              </Typography>
              <Typography
              ...
              >
                <strong>Sri Lanka Offices</strong><br />
                No. 100, Alivanniyar Road, Sammanthurai, SriLanka<br />
                <Divider sx={{ my: 1.5, opacity: 0.5 }} />
                <strong>Saudi Arabia Offices:</strong><br />
            ...
            {/* Contact & 24 Hours Availability Section */}
            <Box sx={{ flexBasis: { xs: "100%", md: "25%" } }}>
              ...
              <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
                ...
                <Link
                  ...
                  sx={{
                    color: brandBlue, fontSize: "0.9rem", textDecoration: "none", fontFamily: primaryFont, fontWeight: 700,
                    transition: "all 0.3s ease", "&:hover": { paddingLeft: "5px" },
                  }}
                >
      ...
      <Box sx={{ backgroundColor: "#000", py: 3, borderTop: "1px solid rgba(255,255,255,0.1)" }}>
        <Container maxWidth="lg" sx={{ display: "flex", flexDirection: { xs: "column", sm: "row" }, justifyContent: "space-between", alignItems: "center", gap: 2 }}>
          <Typography variant="body2" sx={{ color: "rgba(255,255,255,0.5)", fontSize: "0.8rem", fontFamily: primaryFont }}>
            © 2026 <strong>Brainiacs Campus</strong>. All Rights Reserved.
          </Typography>
          
          <Stack direction="row" spacing={3} sx={{ display: { xs: "none", md: "flex" } }}>
            {["Home", "Portfolio", "Expertise", "Contact us"].map((text) => (
              <Link
                key={text}
                href="#"
                sx={{
                  color: "rgba(255,255,255,0.8)", textDecoration: "none", fontSize: "0.75rem", textTransform: "uppercase", letterSpacing: 1, fontFamily: primaryFont, position: "relative", transition: "color 0.3s",
                  "&::after": { content: '""', position: "absolute", width: "0%", height: "1px", bottom: -4, left: 0, backgroundColor: brandBlue, transition: "width 0.3s ease" },
